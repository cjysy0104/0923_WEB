...
<pre>
	...
	3. 브라우저가 전체 페이지 다시 로딩 -> 깜빡임 발생
	
	비동기방식:
	1. 사용자가 버튼 클릭
	2. JavaScript를 이용해서 데이터만 서버로 전송
...
<pre>
	...
	자바스크립트 객체 XXXX 자바스크립트 객체 모양으로 문자열을 만든거
	...
	웹개발 표준 데이터 형식
	REST API의 기본 포맷
	설정파일 XML -> JSON(설정파일은 YAML이 인기 더 많다.)
</pre>
...
<h2>jQuery를 사용한 AJAX요청 및 응답</h2>
   ...
   <h3>1. 버튼을 클릭하여 서버에 데이터를 전송하고 단순 문자열데이터 응답받기</h3>
   ...
   아이디 입력 : <input type="test" id=search-id >
