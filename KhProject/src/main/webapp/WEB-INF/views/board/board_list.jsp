		...
		<div class="col-lg-10">
			<div class="panel-body">
				<h2 class="page-header">
					<span style="color: #52b1ff;">KH</span> 자유 게시판 <a
						href="enrollForm.board" class="btn float-right"
				...
				<div id="search-area" class="form-group">
					<form action="search.board" method="get">
						...
						<button type="submit" class="btn btn-block"
							style="background: #52b1ff; color: white">검색</button>
					</form>
				</div>
			</div>
			<c:if test="${ not empty condition }">
				<script>
					$(function(){
						$('#search-area option[value=${ keyword }')
	...
	<div class="paging-area" align="center">
		...
		<c:choose>
			<c:when test="${not empty condition }">
				...
				<button class="btn btn-outline-primary" style="color: #52b1ff;"
					onclick="location.href='search.board?page=${i}&condition=${ condition }&query=${ keyword }'">${ i }
				</button>
